...
export const CONTATOS: Contato[] = [
  { id: "c1", nome: "Fernanda Albuquerque", email: "fernanda@tecnova.com.br", telefone: "(11) 98812-4471", empresa: "TecNova Sistemas", cargo: "Diretora de TI", status: "cliente", origem: "indicacao", valorEstimado: 84000, criadoEm: "2026-02-11", ultimoContato: "2026-07-18", ownerId: "u3" },
  { id: "c2", nome: "Bruno Menezes", email: "bruno@lojaverde.com", telefone: "(21) 99145-8820", empresa: "Loja Verde", cargo: "Sócio", status: "ativo", origem: "site", valorEstimado: 32000, criadoEm: "2026-04-02", ultimoContato: "2026-07-20", ownerId: "u2" },
  { id: "c3", nome: "Patrícia Nunes", email: "patricia@constrular.com.br", telefone: "(31) 98410-1190", empresa: "ConstruLar", cargo: "Gerente Comercial", status: "lead", origem: "anuncio", valorEstimado: 51000, criadoEm: "2026-06-19", ultimoContato: "2026-07-15", ownerId: "u2" },
  { id: "c4", nome: "Diego Ferreira", email: "diego@agilfrete.com", telefone: "(41) 99628-3312", empresa: "Ágil Frete", cargo: "CEO", status: "ativo", origem: "outbound", valorEstimado: 120000, criadoEm: "2026-03-27", ultimoContato: "2026-07-21", ownerId: "u3" },
  { id: "c5", nome: "Camila Rocha", email: "camila@bellacosmeticos.com.br", telefone: "(11) 97733-0021", empresa: "Bella Cosméticos", cargo: "Head de Marketing", status: "cliente", origem: "evento", valorEstimado: 67000, criadoEm: "2026-01-15", ultimoContato: "2026-07-19", ownerId: "u3" },
  { id: "c6", nome: "Henrique Barros", email: "henrique@ativapharma.com", telefone: "(51) 98122-7745", empresa: "Ativa Pharma", cargo: "Diretor Financeiro", status: "lead", origem: "site", valorEstimado: 29000, criadoEm: "2026-07-05", ultimoContato: "2026-07-12", ownerId: "u2" },
  { id: "c7", nome: "Larissa Teixeira", email: "larissa@estudioform.com", telefone: "(48) 99880-1234", empresa: "Estúdio Form", cargo: "Proprietária", status: "ativo", origem: "indicacao", valorEstimado: 18000, criadoEm: "2026-05-08", ultimoContato: "2026-07-17", ownerId: "u2" },
  { id: "c8", nome: "Anderson Prado", email: "anderson@maxlog.com.br", telefone: "(62) 99450-6612", empresa: "MaxLog", cargo: "COO", status: "inativo", origem: "outbound", valorEstimado: 95000, criadoEm: "2025-11-22", ultimoContato: "2026-05-30", ownerId: "u3" },
  { id: "c9", nome: "Juliana Moreira", email: "juliana@vitrinedigital.com", telefone: "(11) 98005-7781", empresa: "Vitrine Digital", cargo: "Fundadora", status: "cliente", origem: "evento", valorEstimado: 43000, criadoEm: "2026-02-28", ultimoContato: "2026-07-22", ownerId: "u3" },
  { id: "c10", nome: "Thiago Souza", email: "thiago@nortecafe.com.br", telefone: "(85) 99711-3308", empresa: "Norte Café", cargo: "Diretor", status: "lead", origem: "anuncio", valorEstimado: 22000, criadoEm: "2026-07-09", ultimoContato: "2026-07-14", ownerId: "u2" },
  { id: "c11", nome: "Beatriz Cardoso", email: "beatriz@plenaseg.com.br", telefone: "(11) 98890-4523", empresa: "Plena Seguros", cargo: "Gerente de Operações", status: "ativo", origem: "indicacao", valorEstimado: 74000, criadoEm: "2026-04-16", ultimoContato: "2026-07-20", ownerId: "u3" },
  { id: "c12", nome: "Marcelo Dias", email: "marcelo@urbanmoveis.com", telefone: "(19) 99342-8890", empresa: "Urban Móveis", cargo: "Sócio-diretor", status: "lead", origem: "site", valorEstimado: 38000, criadoEm: "2026-06-30", ultimoContato: "2026-07-11", ownerId: "u2" },
  { id: "c13", nome: "Renata Farias", email: "renata@clinicasorriso.com.br", telefone: "(71) 98221-5567", empresa: "Clínica Sorriso", cargo: "Administradora", status: "cliente", origem: "indicacao", valorEstimado: 26000, criadoEm: "2026-03-04", ultimoContato: "2026-07-16", ownerId: "u3" },
  { id: "c14", nome: "Gustavo Almeida", email: "gustavo@fortetech.com", telefone: "(11) 99604-7712", empresa: "Forte Tech", cargo: "CTO", status: "ativo", origem: "outbound", valorEstimado: 158000, criadoEm: "2026-05-21", ultimoContato: "2026-07-21", ownerId: "u3" },
];
